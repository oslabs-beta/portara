...
// Redis Rate Limiter -------------------------------------------
var rateLimiter = function (limit, per, ip, scope) { return __awaiter(void 0, void 0, void 0, function () {
    var perNum, perWord, timeFrameMultiplier, expirationTimeVariable, key, exists, value;
    var _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                perNum = Number((_a = per.match(/\d+/g)) === null || _a === void 0 ? void 0 : _a.toString());
            ...
            case 1:
                ...
                return [4 /*yield*/, client.setex(key, expirationTimeVariable, 1)];
            case 2:
                _c.sent();
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, rateLimiter(limit, per, context.req.ip, info.fieldName)];
                        case 1:
                            underLimit = _a.sent();
                            if (underLimit) {
                    ...
                    return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    object = originalArgs[0], args = originalArgs[1], context = originalArgs[2], info = originalArgs[3];
                                    return [4 /*yield*/, rateLimiter(limit, per, context.req.ip, type.toString())];
                                case 1:
                                    underLimit = _a.sent();
                                    if (underLimit) {
                                        return [2 /*return*/, resolve.apply(void 0, originalArgs)];
